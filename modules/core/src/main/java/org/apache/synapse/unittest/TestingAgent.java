...
class TestingAgent {
    ...
    Map.Entry<Boolean, TestSuiteSummary> processTestArtifact(SynapseTestCase synapseTestCase,
        ...
        try {
            ...
            switch (mainTestArtifactType) {
                ...
                case TYPE_SEQUENCE:
                    ...
                    if (key.contains(artifactNameOrKey)) {
                        ...
                        log.info("Sequence main test artifact deployed successfully");
                    } else {
                ...
                case TYPE_PROXY:
                    ...
                    if (key.contains(artifactNameOrKey)) {
                        ...
                        testSuiteSummary.setDeploymentStatus(Constants.PASSED_KEY);
                        log.info("Proxy main test artifact deployed successfully");
                    } else {
                ...
                case TYPE_API:
                    ...
                    if (key.contains(artifactNameOrKey)) {
                        ...
                        testSuiteSummary.setDeploymentStatus(Constants.PASSED_KEY);
                        log.info("API main test artifact deployed successfully");
                    } else {
            ...
            log.error("Main test artifact " + mainTestArtifactType + " deployment failed", e);
        ...
        for (int x = 0; x < synapseTestCase.getArtifacts().getSupportiveArtifactCount(); x++) {
            if (isArtifactDeployed) {
                ...
                log.error(synapseTestCase.getArtifacts().getSupportiveArtifact(x).getArtifactType()
                        + " main test artifact deployment failed");
                break;
            }
        }
